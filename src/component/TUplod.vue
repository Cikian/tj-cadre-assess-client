  ...
  methods:{
      ...
      if(this.fileType===FILE_TYPE_IMG){
        if(fileType.indexOf('image')<0){
          ...
          this.$confirm({
            ...
            content: h => <div style="color:red;">请上传图片</div>,
    ...
    handleChange(info) {
      ...
      if(info.file.status==='done'){
        ...
        const errorMessage = `${info.file.name} 上传失败`;
        this.$confirm({
            title: '消息提示',

            content: h => <div style="color:red;">{errorMessage}</div>,
    ...
    moveLast(){
      ...
      if(index==0){
        ...
        this.$confirm({
            ...
            content: h => <div style="color:red;">未知的操作</div>,
