      ...
      <a-col :md="24" :sm="24">
        <a-card :bordered="false">
          ...
          <a-table
            ...
            size="middle"
            rowKey="id"
            :columns="isScope ? scopeColumns : columns"
...
export default {
  name: 'TSelectUserByDepModal',
  components: { TModal },
  props: ['modalWidth', 'multi', 'userIds', 'store', 'text', 'getLeader', 'departId', 'isScope', 'year'],
  data() {
    return {
      queryParam: {
        username: ''
  ...
  methods: {
    ...
    getQueryParams() {
      ...
      param.getLeader = this.getLeader
