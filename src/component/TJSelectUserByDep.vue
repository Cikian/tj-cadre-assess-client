...
<script>
  ...
  import TJSelectUserByDepModal from './modal/TJSelectUserByDepModal.vue'

  export default {
    name: 'TJSelectUserByDep',
    components: { TJSelectUserByDepModal },
    props: {
      getLeader: {
        type: Boolean,
        required: false,
