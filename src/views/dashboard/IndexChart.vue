<template>
  <div class='page-header-index-wide'>
    ...
    <a-row :gutter='24'>
                ...
                <a-dropdown>
                  ...
                  <a-menu slot="overlay">
                    <a-menu-item @click="stopAssessing('regular')">
                      <div v-has="'gbc:admin'" style="width: 50px" class='stop-assess'>结束</div>
                    </a-menu-item>
                    <a-menu-item @click="revocation('regular')">
                      <div v-has="'gbc:admin'" style="width: 50px; background-color: #ff6715" class='stop-assess'>撤回
                      </div>
                    </a-menu-item>
                  </a-menu>
                </a-dropdown>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px',position:relative }"
             v-if='this.businessIndexLeaderlist'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1185.png' alt=''>
        </div>
        <chart-card style='height: 160px;border-radius: 20px;' :loading='loading' title='业务工作测评'
                    :total="businesscomputed+'%'">

          <div>
            <mini-progress color='rgb(2, 96, 254)' :target='businesscomputed' :percentage='businesscomputed'
                           :height='8' />
          </div>
          <template slot='footer' style='display: flex;align-items: center;'>
            <div style='display: flex; justify-content: space-between; width: 100%'>
              <div style='display: flex;'>
                <div flag='down' style='margin-right: 16px;;display: flex;align-items: center;'>
                  ...
                  <span slot='term'>已完成</span>
                  <span style='color: rgb(22, 201, 121);font-weight: 600;margin-left: 2px;'>
                  {{ businessIndexLeaderlist.complete }}
                  </span>
                </div>
                <div flag='up' style='margin-right: 16px;display: flex;align-items: center;'>
                  <!-- <div style="width: 10px;height: 10px;background-color: red;border-radius: 50%;"></div> -->
                  <span slot='term'>未完成</span>
                  <span style='color: rgb(252, 164, 19);font-weight: 600;margin-left: 2px;'>
                  {{ businessIndexLeaderlist.uncompleted }}
                  </span>
                </div>
              </div>
              <div>
                <a-dropdown>
                  <div v-has="'gbc:admin'" class='stop-assess'>结束业务工作测评</div>
                  <a-menu slot="overlay">
                    <a-menu-item @click="stopAssessing('business')">
                      <div v-has="'gbc:admin'" style="width: 50px" class='stop-assess'>结束</div>
                    </a-menu-item>
                    <a-menu-item @click="revocation('business')">
                      <div v-has="'gbc:admin'" style="width: 50px; background-color: #ff6715" class='stop-assess'>撤回
                      </div>
                    </a-menu-item>
                  </a-menu>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px' }" v-if='this.businessIndexLeaderlist===null'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1185.png' alt=''>
        </div>
        <chart-card style='height: 160px;font-size: 20px;' :loading='loading' title='业务工作测评'>
          当前无正在进行的业务工作测评
          <template slot='footer'>
            <div style='display: flex;align-items: center; justify-content: right; height: 100%'>
              <div @click='initBusinessAssess' type='primary' icon='plus' v-has="'gbc:admin'" class='finallyb'>发起业务工作测评
              </div>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px',position:relative }"
             v-if='this.reportIndexLeaderlist'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1186.png' alt=''>
        </div>
        <chart-card style='height: 160px;border-radius: 20px;' :loading='loading' title='一报告两评议'
                    :total="reportcomputed+'%'">

          <div>
            <mini-progress color='rgb(2, 96, 254)' :target='reportcomputed' :percentage='reportcomputed'
                           :height='8' />
          </div>
            ...
            <div style='display: flex; justify-content: space-between; width: 100%'>
              <div style='display: flex;'>
                <div flag='down' style='margin-right: 16px;;display: flex;align-items: center;'>
                  ...
                  <span slot='term'>已完成</span>
                  <span style='color: rgb(22, 201, 121);font-weight: 600;margin-left: 2px;'>
                  {{ reportIndexLeaderlist.uncompleted }}
                  </span>
                </div>
                <div flag='up' style='margin-right: 16px;display: flex;align-items: center;'>
                  <!-- <div style="width: 10px;height: 10px;background-color: red;border-radius: 50%;"></div> -->
                  <span slot='term'>未完成</span>
                  <span style='color: rgb(252, 164, 19);font-weight: 600;margin-left: 2px;'>
                  {{ reportIndexLeaderlist.complete }}
                  </span>
                </div>
              </div>
              <div>
                <a-dropdown>
                  <div v-has="'gbc:admin'" class='stop-assess'>结束一报告两评议</div>
                  <a-menu slot="overlay">
                    <a-menu-item @click="stopAssessing('report')">
                      <div v-has="'gbc:admin'" style="width: 50px" class='stop-assess'>结束</div>
                    </a-menu-item>
                    <a-menu-item @click="revocation('report')">
                      <div v-has="'gbc:admin'" style="width: 50px; background-color: #ff6715" class='stop-assess'>撤回
                      </div>
                    </a-menu-item>
                  </a-menu>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px' }" v-if='this.reportIndexLeaderlist===null'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1186.png' alt=''>
        </div>
        <chart-card style='height: 160px;font-size: 20px;' :loading='loading' title='一报告两评议'>
          当前无正在进行的一报告两评议
          <template slot='footer'>
            <div style='display: flex;align-items: center; justify-content: right; height: 100%'>
              <div @click='initReportAssess' type='primary' v-has="'gbc:admin'" icon='plus' class='finallyb'>发起一报告两评议
              </div>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px',position:relative }"
             v-if='this.annualIndexLeaderlist'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1187.png' alt=''>
        </div>
        <chart-card style='height: 160px;border-radius: 20px;' :loading='loading' title='年度考核'
                    :total="annualcomputed+'%'">
          <div>
            <mini-progress color='rgb(2, 96, 254)' :target='annualcomputed' :percentage='annualcomputed'
                           :height='8' />
          </div>
          ...
          <template slot='footer' style='display: flex;align-items: center;'>
            <div style='display: flex; justify-content: space-between; width: 100%'>
              <div style='display: flex;'>
                <div flag='down' style='margin-right: 16px;;display: flex;align-items: center;width: 48%;'>
                  <!-- <div style="width: 10px;height: 10px;background-color: green;border-radius: 50%;"></div> -->
                  <span slot='term'>已完成</span>
                  <span style='color: rgb(22, 201, 121);font-weight: 600;margin-left: 2px;'>
                  {{ annualIndexLeaderlist.complete }}
                  </span>
                </div>
                <div flag='up' style='margin-right: 16px;display: flex;align-items: center;width: 48%;'>
                  <!-- <div style="width: 10px;height: 10px;background-color: red;border-radius: 50%;"></div> -->
                  <span slot='term'>未完成</span>
                  <span style='color: rgb(252, 164, 19);font-weight: 600;margin-left: 2px;'>
                  {{ annualIndexLeaderlist.uncompleted }}
                  </span>
                </div>
              </div>
              <div>
                <a-dropdown>
                  <div v-has="'gbc:admin'" class='stop-assess'>结束年度考核</div>
                  <a-menu slot="overlay">
                    <a-menu-item @click="stopAssessing('annual')">
                      <div v-has="'gbc:admin'" style="width: 50px" class='stop-assess'>结束</div>
                    </a-menu-item>
                    <a-menu-item @click="revocation('annual')">
                      <div v-has="'gbc:admin'" style="width: 50px; background-color: #ff6715" class='stop-assess'>撤回
                      </div>
                    </a-menu-item>
                  </a-menu>
      ...
      <a-col :sm='24' :md='12' :xl='6' :style="{ marginBottom: '24px' }" v-if='this.annualIndexLeaderlist===null'>
        <div style='width: 35px;height: 35px;margin: 5px 5px;position: absolute;top:10px;right: 40px;z-index: 3;'>
          <img src='../../assets/组合 1187.png' alt=''>
        </div>
        <chart-card style='height: 160px;font-size: 20px;' :loading='loading' title='年度考核'>
          当前无正在进行的年度考核
          <template slot='footer'>
            <div style='display: flex;align-items: center; justify-content: right; height: 100%'>
              <div style='background-color: #ff4d00' @click='downloadDepartName' type='primary' icon='import'
              ...
              <div style='background-color: #ff4d00' @click='downloadFile("/template/发起年度考核上传人员模板.xlsx")'
                   type='primary' icon='import' class='finallyb'> 下载上传模板
              </div>

              <div @click='initAnnualAssess' type='primary' v-has="'gbc:admin'" icon='plus' class='finallyb'>
                发起年度考核
              </div>
            </div>
          </template>
    ...
    <div style='font-weight: 700;font-size: 25px;margin: 10px 10px;display: flex;align-items: center;'>
      <img style='width: 35px;height: 25px;margin: 5px 5px;' src='../../assets/list.png' alt=''>快捷入口
    </div>
    ...
    <div style='font-weight: 700;font-size: 25px;margin-top: 10px;display: flex;align-items: center;'>
      <img style='width: 35px;height: 25px;margin-top: 5px;' src='../../assets/list.png' alt=''> 当前未填报处室（单位）信息
    </div>
    <a-row :gutter='12'>
      <a-card :loading='loading' :class="{ 'anty-list-cust':true }" :bordered='false' :style="{ marginTop: '24px' }">
        ...
        <a-tabs v-model='indexBottomTab' size='large' :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
          ...
          <a-tab-pane loading='true' tab='业务工作测评' key='2'>
            <a-table :pagination='false' :dataSource='dataSource2' rowKey='id' :columns='columns1'
                     style='height:400px;overflow-y: scroll;'>
              <template slot='deadline' slot-scope='text, record, index'>
                {{ formatDeadline(text) }}
              </template>
          ...
          <a-tab-pane loading='true' tab='一报告两评议' key='3'>
            <a-table :pagination='false' :dataSource='dataSource3' rowKey='id' :columns='columns2'
                     style='height:400px;overflow-y: scroll;'>
              <template slot='deadline' slot-scope='text, record, index'>
                {{ formatDeadline(text) }}
              </template>
          ...
          <a-tab-pane loading='true' tab='年度考核管理' key='4'>
            <a-table :pagination='false' :dataSource='dataSource4' rowKey='id' :columns='columns2'
                     style='height:400px;overflow-y: scroll;'>
    ...
    >
      <template slot='footer'>
        ...
        <a-button key='submit' type='primary' :loading='btnLoading || uploading' @click='onSubmitAnnual'> 发起
        </a-button>
      </template>
      ...
      >
        <a-button :loading='uploading' type='primary' icon='import'>导入</a-button>
      </a-upload>
    ...
    <a-modal :width='900' v-model='addAssessVisible3' ok-text='发起' cancel-text='取消' @ok='onSubmit3'
             @cancel='handleClose'>
      <template slot='title'>
...
import { downloadFile, getAction, getFileAccessHttpUrl } from '@/api/manage'
...
export default {
      ...
      settinglist: [
        {
          ...
          img: require('@/assets/组合 1196.png')
        },
        // {
        //   name: '业务工作测评互评单位配置',
        //   text: '业务工作测评互评单位配置',
        ...
        // },
        {
          ...
          img: require('@/assets/组合 1198.png')
        }, {
          name: '年度考核优秀比例配置',
          text: '设置年度考核各类型单位推优上限比例',
          route: '/sys/config/excratio',
          img: require('@/assets/组合 1201.png')
        }, {
          name: '问责影响期配置',
          text: '设置各类型问责的影响期',
          route: '/sys/config/a-period',
          img: require('@/assets/组合 1200.png')
        }, {
          name: '一报告两评议民主测评配置',
          text: '设置以及修改“一报告两评议”民主评议项、分数',
          route: '/sys/config/report/democracyConfig',
          img: require('@/assets/组合 1199.png')
        }, {
          name: '负面清单填写权限',
          text: '设置业务工作测评自动生成的优秀、自好、一般等次默认比例',
          route: '/config/negativeConfig',
          img: require('@/assets/组合 1202.png')
        }, {
          name: '人员辅助领导设置',
          text: '设置及修政各局领导分管的处室(单位)',
          route: '/config/assist',
          img: require('@/assets/组合 1204.png')
        }, {
          name: '分管领导外考核人员配置',
          text: '设置年魔考校民主测评各笑型票的杈遭以及通评项',
          route: '/config/leader/assess',
          img: require('@/assets/组合 1205.png')
        }
      ],
      loading: true,
      cardCount: {
  ...
  methods: {
    ...
    beforeUpload(file) {
      ...
      if (allowType.indexOf(fileExtension) < 0) {
        this.$error({
          title: '请上传' + allowType.join('、') + '格式的文件'
        })
    ...
    handleImportExcel(info) {
      if (info.file.status === 'done' && info.file.response.success) {
        ...
        const mess = `${info.file.response.message}`
        this.$error({
          title: '解析失败',
          content: (h) => <div
            style="color:red;">文件解析失败，请确认上传的表格中不存在公式、图片等非纯文本内容，然后重新尝试上传！</div>
        })
        this.uploading = false
      }
    },
