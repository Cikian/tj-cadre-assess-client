    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="endTime" label="截至日期" class="endTime">
          <j-date style="width: 100%" :getCalendarContainer="node => node.parentNode" v-model="model.endTime" placeholder="请选择结束时间"  dateFormat="YYYY-MM-DD" />
        </a-form-model-item>
...
<!--        </a-form-model-item>-->
        <a-form-model-item label='通知附件' :labelCol='labelCol' :wrapperCol='wrapperCol' prop='msgContent'>
          <j-upload :biz-path='"/announce/file"' v-model='model.msgContent'></j-upload>
        </a-form-model-item>
      </a-form-model>
    </a-spin>
  </a-modal>
...
<script>
  ...
  export default {
    components: { JEditor, JDate, SelectUserListModal,JUpload},
