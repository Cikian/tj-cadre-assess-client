    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="局领导" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="leader">
<!--              <j-select-user-by-dep v-model="model.leader" store="id" text="realname" :multi="true"/>-->
              <t-select-user-by-dep placeholder='请选择领导' :get-leader="true" v-model='model.leader' store='id' text='realname' :multi='true' />
            </a-form-model-item>
          </a-col>
          ...
          <a-col :span="24">
            <a-form-model-item label="出生日期" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="birth">
              <j-date disabled placeholder="请选择出生日期" v-model="model.birth"  style="width: 100%" />
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
           leader: [
              { required: true, message: '请输入局领导!'},
           ],
           people: [
              { required: true, message: '请输入辅助人员!'},
           ],
        },
        url: {
          add: "/assess/annual/assessAssistConfig/add",
          edit: "/assess/annual/assessAssistConfig/edit",
          queryById: "/assess/annual/assessAssistConfig/queryById"
        }
      }
    },
    computed: {
