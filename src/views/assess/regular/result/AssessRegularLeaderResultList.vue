<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" @keyup.enter.native="searchQuery">
        <a-row :gutter="24">
          ...
          <!--            @click="handleExportXls('平时考核干部信息清单')"-->
          <!--            >导出</a-button-->
          <!--          >-->
        </a-row>
        <a-row style="margin-bottom: 16px">
          <a-col :xl="24" :lg="7" :md="8" :sm="24">
            <a-button @click="openExport" type="primary" icon="clock-circle" style="margin-right: 8px">
              下载历史考核人员信息
            </a-button>
            <a-button @click="openAdjustment" type="primary" icon="edit">考核人员调整</a-button>
            <a-button type="primary" icon="download" style="margin-left: 8px"
                      @click="handleExportXls('平时考核信息汇总')">导出考核成绩
            </a-button>
            <a-button type="primary" icon="pie-chart" style="margin-left: 8px"
                      @click="openAssessDetail">查看考核信息
            </a-button>
            <a-button type="primary" icon="pie-chart" style="margin-left: 8px"
                      @click="openLeaderAssessDetail">查看局领导测评进度
            </a-button>
          </a-col>
        </a-row>
      </a-form>
    ...
    <leader-detail-modal ref="leaderDetailModal"></leader-detail-modal>
...
import LeaderDetailModal from '@/views/assess/regular/result/modules/LeaderDetailModal.vue'
...
export default {
  ...
  data() {
    return {
      ...
      superFieldList: [],
      currentFileName: '',
      currentPersonnelDepartment: '干部考核结果',
      currentPersonnelValue: 1,
      detailVisible: false,
      detail: {},
  ...
  created() {
    ...
    // this.queryParam.isLeader = 1
    this.queryParam.adminDepartment = '干部处'
  ...
  methods: {
    ...
    openLeaderAssessDetail(){
      this.$refs.leaderDetailModal.title = '局领导测评进度'
      this.$refs.leaderDetailModal.init()
      this.$refs.leaderDetailModal.visible = true
    }
  }
}
</script>
