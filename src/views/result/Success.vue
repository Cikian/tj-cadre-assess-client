    ...
    <result :is-success="true" :description="description" :title="title">
      ...
      <div>
        ...
        <a-steps :current="1" :direction="isMobile() && directionType.vertical || directionType.horizontal" progressDot>
          <a-step >
            <span style="font-size: 16px" slot="title">创建项目</span>
          ...
          <a-step title="部门初审">
            <span style="font-size: 16px" slot="title">部门初审</span>
            <template slot="description">
              <div style="fontSize: 12px; color: rgba(0, 0, 0, 0.45); position: relative; left: 42px;" slot="description" >
                <div style="margin: 8px 0 4px">
                  周毛毛
          ...
          <a-step title="财务复核">
            <span style="font-size: 16px" slot="title">财务复核</span>
          </a-step>
          <a-step title="完成" >
            <span style="font-size: 16px" slot="title">完成</span>
          </a-step>
        </a-steps>
      </div>
    </result>
